...
#elbow dataset, menentukan jumlah cluster
clusters=[]
for i in range(1,11):
...
def k_means(n_clust):
    ...
    sns.scatterplot(x='Income', y='Score', hue='Labels', size='Labels', data=X, palette=sns.color_palette('hls', n_clust), markers=True)
